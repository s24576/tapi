  ...
  try {
    ...
    res
      ...
      .json({
        ...
        _links: {
          self: { href: "http://localhost:3000/api/zlecenia", method: "GET" },
          add: {
            href: "http://localhost:3000/api/zlecenia/add",
            method: "POST",
          },
          delete: {
            href: `http://localhost:3000/api/zlecenia/delete/{id}`,
            method: "DELETE",
          },
          update: {
            href: `http://localhost:3000/api/zlecenia/update/{id}`,
            method: "PUT",
          },
        },
      });
...
router.get("/zlecenia/:id", async (req, res) => {
  ...
  try {
    ...
    res
      ...
      .json({
        ...
        _links: {
          self: {
            href: `http://localhost:3000/api/zlecenia/${orderId}`,
            method: "GET",
          },
          update: {
            href: `http://localhost:3000/api/zlecenia/update/${orderId}`,
            method: "PUT",
          },
          delete: {
            href: `http://localhost:3000/api/zlecenia/delete/${orderId}`,
            method: "DELETE",
          },
        },
      });
...
router.put("/zlecenia/:id", async (req, res) => {
  const orderId = req.params.id;
  ...
  try {
    ...
    const orderIndex = orders.findIndex(
      (o) => o.zlecenie.numer_zlecenia === orderId
    );
    ...
    res
      ...
      .json({
        ...
        _links: {
          ...
          allOrders: {
            href: "http://localhost:3000/api/zlecenia",
            method: "GET",
          },
        },
      });
...
router.post("/zlecenia/add", async (req, res) => {
  const newOrder = req.body;

  if (
    !newOrder.zlecenie?.numer_zlecenia ||
    !newOrder.zlecenie?.status ||
    !newOrder.zlecenie?.klient ||
    !newOrder.zlecenie?.trasa
  ) {
  ...
  try {
    ...
    const existingOrder = orders.find(
      (o) => o.zlecenie.numer_zlecenia === newOrder.zlecenie.numer_zlecenia
    );
    ...
    res
      ...
      .json({
        ...
        _links: {
          self: {
            href: `http://localhost:3000/api/zlecenia/${newOrder.zlecenie.numer_zlecenia}`,
            method: "GET",
          },
          allOrders: {
            href: "http://localhost:3000/api/zlecenia",
...
router.delete("/zlecenia/:id", async (req, res) => {
  const orderId = req.params.id;
...
router.patch("/zlecenia/:id", async (req, res) => {
  const orderId = req.params.id;
